  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_BASE_URL}/api/SignIn/User`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-sky-400 text-white p-8 rounded-lg shadow-lg w-96">
        ...
        <h2 className="text-base font-bold text-center mb-6">User Sign In</h2>
        ...
        <div className="text-center mt-4">
          <Link to="/SignUp/User" className="text-white hover:underline">
